...
namespace Rusu_Flavia_Lab2.Migrations
{
    ...
    [Migration("20231025160912_BookCategory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rusu_Flavia_Lab2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rusu_Flavia_Lab2.Models.Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rusu_Flavia_Lab2.Models.BookCategory", b =>
                {
                    b.HasOne("Rusu_Flavia_Lab2.Models.Book", "Book")
                        .WithMany("BookCategories")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rusu_Flavia_Lab2.Models.Category", "Category")
                        .WithMany("BookCategories")
